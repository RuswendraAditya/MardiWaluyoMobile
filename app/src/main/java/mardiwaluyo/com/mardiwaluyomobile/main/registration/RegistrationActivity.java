...
import mardiwaluyo.com.mardiwaluyomobile.main.registration.service.RegistrationServices;
...
public class RegistrationActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDataPasien();
        if(SharedData.getKey(RegistrationActivity.this, "maxHari")!=null)
        {  Integer maxHari  = Integer.valueOf(SharedData.getKey(RegistrationActivity.this,"maxHari"))-1;
            textViewinFo.setText("  * Pendaftaran Maksimal "+maxHari +" Hari ");
        }
